...
def translate_text(text_list, src_lang="ko"):
    if src_lang=="ko":
        system_prompt = ko_to_en_system_prompt
    elif src_lang=="en":
        system_prompt = en_to_ko_system_prompt
    else:
        raise ValueError("src_lang must be 'ko' or 'en'")
...
def main(image, ocr_model, remover_model, mask_rank=None, src_lang="ko", font_path="./Roboto-Medium.ttf"):
    ...
    translated_texts = translate_text(ocr_results, src_lang)
