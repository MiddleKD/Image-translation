...
load_dotenv()
src_lang = os.getenv("SRC_LANG")
font_path = os.getenv("FONT_PATH")
lama_model_path = os.getenv("LAMA_MODEL_PATH")
...
ocr_model = call_easyocr([src_lang], ocr_model_path)
...
def run_inference(edited_image, resize_size):
...
with gr.Blocks(js=js_func, title="이미지 번역기") as demo:
    ...
    run_btn.click(run_inference, [input_image, resize_size_box], output_image)
